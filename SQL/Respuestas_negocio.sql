...
--Lista los usuarios que cumplan anos hoy cuyas ventas en enero 2020 sea superior a 1500.
...
GROUP BY mes, a�o, c.id, c.nombre, c.apellido
ORDER BY monto_total_transaccionado DESC
LIMIT 5;

--Poblar una nueva tabla con el precio y estado de los �tems a fin del d�a.
